...
.ai-refresh { padding: 6px 16px; border-radius: 6px; border: 1px solid rgba(255,255,255,0.1); background: rgba(59,130,246,0.1); color: #60a5fa; font-size: 12px; cursor: pointer; transition: opacity .2s; }
...
.ai-body { background: var(--bg-card); border: 1px solid var(--border); border-radius: 10px; padding: 18px; }
...
.ai-item { background: rgba(255,255,255,0.03); border-radius: 8px; padding: 10px; }
...
.risk-item { font-size: 12px; color: #fbbf24; background: rgba(251,191,36,0.08); padding: 4px 10px; border-radius: 6px; }
